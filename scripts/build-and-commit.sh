...
TARGET_API=ovp lucybot build --prerender --truncate_prerender '^(?!.*\.html$)' --destination generated/ovp
...
TARGET_API=ott lucybot build --prerender --truncate_prerender --destination generated/ott
