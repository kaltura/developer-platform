...
access_control_profile.rules[0] = KalturaRule()
access_control_profile.rules[0].code = "thiscode"
access_control_profile.rules[0].contexts = []
access_control_profile.rules[0].contexts[0] = KalturaContextTypeHolder()
access_control_profile.rules[0].contexts[0].type = KalturaContextType.PLAY
access_control_profile.rules[0].contexts[1] = KalturaContextTypeHolder()
access_control_profile.rules[0].conditions = []
access_control_profile.rules[0].conditions[0] = KalturaDeliveryProfileCondition()
access_control_profile.rules[0].conditions[0].description = "cond 1"
access_control_profile.rules[0].conditions[1] = KalturaDeliveryProfileCondition()
access_control_profile.rules[0].conditions[1].description = "cond 2"
access_control_profile.rules[1] = KalturaRule()
