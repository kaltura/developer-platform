...
access_control_profile.rules[0].contexts[0].type = 1
access_control_profile.rules[0].contexts[1] = KalturaContextTypeHolder.new()
access_control_profile.rules[0].conditions = []
access_control_profile.rules[0].conditions[0] = KalturaCondition.new()
access_control_profile.rules[0].conditions[0].description = "cond 1"
access_control_profile.rules[0].conditions[1] = KalturaCondition.new()
